...
1. Which of the following is not one of the Wickham Six functions? <div class='webex-radiogroup' id='radio_BAAKCKEYWG'><label><input type="radio" autocomplete="off" name="radio_BAAKCKEYWG" value="answer"></input> <span>melt()</span></label><label><input type="radio" autocomplete="off" name="radio_BAAKCKEYWG" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_BAAKCKEYWG" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_BAAKCKEYWG" value=""></input> <span>filter()</span></label></div>


2. Which of the following functions would I use if I wanted to keep only certain columns? <div class='webex-radiogroup' id='radio_QQCBANHZNJ'><label><input type="radio" autocomplete="off" name="radio_QQCBANHZNJ" value="answer"></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_QQCBANHZNJ" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_QQCBANHZNJ" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_QQCBANHZNJ" value=""></input> <span>filter()</span></label></div>


3. Which of the following functions would I use if I wanted to keep only certain rows? <div class='webex-radiogroup' id='radio_MLVJJWBIAS'><label><input type="radio" autocomplete="off" name="radio_MLVJJWBIAS" value=""></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_MLVJJWBIAS" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_MLVJJWBIAS" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_MLVJJWBIAS" value="answer"></input> <span>filter()</span></label></div>


4. Which of the following functions would I use if I wanted to add a new column of information? <div class='webex-radiogroup' id='radio_WXGGYRUFYQ'><label><input type="radio" autocomplete="off" name="radio_WXGGYRUFYQ" value=""></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_WXGGYRUFYQ" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_WXGGYRUFYQ" value="answer"></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_WXGGYRUFYQ" value=""></input> <span>filter()</span></label></div>


5. Which boolean expression would I add to a `filter()` function to keep only Male babies in the original `babynames` data? <div class='webex-radiogroup' id='radio_QUIGZXVCGM'><label><input type="radio" autocomplete="off" name="radio_QUIGZXVCGM" value=""></input> <span>sex == F</span></label><label><input type="radio" autocomplete="off" name="radio_QUIGZXVCGM" value="answer"></input> <span>sex == M</span></label><label><input type="radio" autocomplete="off" name="radio_QUIGZXVCGM" value=""></input> <span>sex < F</span></label><label><input type="radio" autocomplete="off" name="radio_QUIGZXVCGM" value=""></input> <span>Sex == M</span></label></div>
