...
1. Which of the following is not one of the Wickham Six functions? <div class='webex-radiogroup' id='radio_FLBUVJQGWA'><label><input type="radio" autocomplete="off" name="radio_FLBUVJQGWA" value="answer"></input> <span>melt()</span></label><label><input type="radio" autocomplete="off" name="radio_FLBUVJQGWA" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_FLBUVJQGWA" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_FLBUVJQGWA" value=""></input> <span>filter()</span></label></div>


2. Which of the following functions would I use if I wanted to keep only certain columns? <div class='webex-radiogroup' id='radio_CJIVXZGZPQ'><label><input type="radio" autocomplete="off" name="radio_CJIVXZGZPQ" value="answer"></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_CJIVXZGZPQ" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_CJIVXZGZPQ" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_CJIVXZGZPQ" value=""></input> <span>filter()</span></label></div>


3. Which of the following functions would I use if I wanted to keep only certain rows? <div class='webex-radiogroup' id='radio_ACLRHTSORT'><label><input type="radio" autocomplete="off" name="radio_ACLRHTSORT" value=""></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_ACLRHTSORT" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_ACLRHTSORT" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_ACLRHTSORT" value="answer"></input> <span>filter()</span></label></div>


4. Which of the following functions would I use if I wanted to add a new column of information? <div class='webex-radiogroup' id='radio_ADAJTCWDPG'><label><input type="radio" autocomplete="off" name="radio_ADAJTCWDPG" value=""></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_ADAJTCWDPG" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_ADAJTCWDPG" value="answer"></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_ADAJTCWDPG" value=""></input> <span>filter()</span></label></div>


5. Which boolean expression would I add to a `filter()` function to keep only Male babies in the original `babynames` data? <div class='webex-radiogroup' id='radio_QKWYUNFLBO'><label><input type="radio" autocomplete="off" name="radio_QKWYUNFLBO" value=""></input> <span>sex == F</span></label><label><input type="radio" autocomplete="off" name="radio_QKWYUNFLBO" value="answer"></input> <span>sex == M</span></label><label><input type="radio" autocomplete="off" name="radio_QKWYUNFLBO" value=""></input> <span>sex < F</span></label><label><input type="radio" autocomplete="off" name="radio_QKWYUNFLBO" value=""></input> <span>Sex == M</span></label></div>
