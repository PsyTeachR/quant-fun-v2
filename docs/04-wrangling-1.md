...
1. Which of the following is not one of the Wickham Six functions? <div class='webex-radiogroup' id='radio_YZMHTRPFHT'><label><input type="radio" autocomplete="off" name="radio_YZMHTRPFHT" value="answer"></input> <span>melt()</span></label><label><input type="radio" autocomplete="off" name="radio_YZMHTRPFHT" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_YZMHTRPFHT" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_YZMHTRPFHT" value=""></input> <span>filter()</span></label></div>


2. Which of the following functions would I use if I wanted to keep only certain columns? <div class='webex-radiogroup' id='radio_GMXSEILOOI'><label><input type="radio" autocomplete="off" name="radio_GMXSEILOOI" value="answer"></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_GMXSEILOOI" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_GMXSEILOOI" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_GMXSEILOOI" value=""></input> <span>filter()</span></label></div>


3. Which of the following functions would I use if I wanted to keep only certain rows? <div class='webex-radiogroup' id='radio_NXXLCYNJZO'><label><input type="radio" autocomplete="off" name="radio_NXXLCYNJZO" value=""></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_NXXLCYNJZO" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_NXXLCYNJZO" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_NXXLCYNJZO" value="answer"></input> <span>filter()</span></label></div>


4. Which of the following functions would I use if I wanted to add a new column of information? <div class='webex-radiogroup' id='radio_AVUGVNFUDP'><label><input type="radio" autocomplete="off" name="radio_AVUGVNFUDP" value=""></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_AVUGVNFUDP" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_AVUGVNFUDP" value="answer"></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_AVUGVNFUDP" value=""></input> <span>filter()</span></label></div>


5. Which boolean expression would I add to a `filter()` function to keep only Male babies in the original `babynames` data? <div class='webex-radiogroup' id='radio_AYCQOFDHIH'><label><input type="radio" autocomplete="off" name="radio_AYCQOFDHIH" value=""></input> <span>sex == F</span></label><label><input type="radio" autocomplete="off" name="radio_AYCQOFDHIH" value="answer"></input> <span>sex == M</span></label><label><input type="radio" autocomplete="off" name="radio_AYCQOFDHIH" value=""></input> <span>sex < F</span></label><label><input type="radio" autocomplete="off" name="radio_AYCQOFDHIH" value=""></input> <span>Sex == M</span></label></div>
