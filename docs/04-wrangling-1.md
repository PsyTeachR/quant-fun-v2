...
1. Which of the following is not one of the Wickham Six functions? <div class='webex-radiogroup' id='radio_XOOTYCJCNP'><label><input type="radio" autocomplete="off" name="radio_XOOTYCJCNP" value="answer"></input> <span>melt()</span></label><label><input type="radio" autocomplete="off" name="radio_XOOTYCJCNP" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_XOOTYCJCNP" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_XOOTYCJCNP" value=""></input> <span>filter()</span></label></div>


2. Which of the following functions would I use if I wanted to keep only certain columns? <div class='webex-radiogroup' id='radio_LZYNLWMIIA'><label><input type="radio" autocomplete="off" name="radio_LZYNLWMIIA" value="answer"></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_LZYNLWMIIA" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_LZYNLWMIIA" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_LZYNLWMIIA" value=""></input> <span>filter()</span></label></div>


3. Which of the following functions would I use if I wanted to keep only certain rows? <div class='webex-radiogroup' id='radio_JVNSQUVBBS'><label><input type="radio" autocomplete="off" name="radio_JVNSQUVBBS" value=""></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_JVNSQUVBBS" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_JVNSQUVBBS" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_JVNSQUVBBS" value="answer"></input> <span>filter()</span></label></div>


4. Which of the following functions would I use if I wanted to add a new column of information? <div class='webex-radiogroup' id='radio_DVUSEWXMFU'><label><input type="radio" autocomplete="off" name="radio_DVUSEWXMFU" value=""></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_DVUSEWXMFU" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_DVUSEWXMFU" value="answer"></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_DVUSEWXMFU" value=""></input> <span>filter()</span></label></div>


5. Which boolean expression would I add to a `filter()` function to keep only Male babies in the original `babynames` data? <div class='webex-radiogroup' id='radio_NVDGPLQEAU'><label><input type="radio" autocomplete="off" name="radio_NVDGPLQEAU" value=""></input> <span>sex == F</span></label><label><input type="radio" autocomplete="off" name="radio_NVDGPLQEAU" value="answer"></input> <span>sex == M</span></label><label><input type="radio" autocomplete="off" name="radio_NVDGPLQEAU" value=""></input> <span>sex < F</span></label><label><input type="radio" autocomplete="off" name="radio_NVDGPLQEAU" value=""></input> <span>Sex == M</span></label></div>
