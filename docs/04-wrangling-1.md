...
1. Which of the following is not one of the Wickham Six functions? <div class='webex-radiogroup' id='radio_COUSBAFAYD'><label><input type="radio" autocomplete="off" name="radio_COUSBAFAYD" value="answer"></input> <span>melt()</span></label><label><input type="radio" autocomplete="off" name="radio_COUSBAFAYD" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_COUSBAFAYD" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_COUSBAFAYD" value=""></input> <span>filter()</span></label></div>


2. Which of the following functions would I use if I wanted to keep only certain columns? <div class='webex-radiogroup' id='radio_PFSHNVRJNY'><label><input type="radio" autocomplete="off" name="radio_PFSHNVRJNY" value="answer"></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_PFSHNVRJNY" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_PFSHNVRJNY" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_PFSHNVRJNY" value=""></input> <span>filter()</span></label></div>


3. Which of the following functions would I use if I wanted to keep only certain rows? <div class='webex-radiogroup' id='radio_BYFWSNYCFT'><label><input type="radio" autocomplete="off" name="radio_BYFWSNYCFT" value=""></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_BYFWSNYCFT" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_BYFWSNYCFT" value=""></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_BYFWSNYCFT" value="answer"></input> <span>filter()</span></label></div>


4. Which of the following functions would I use if I wanted to add a new column of information? <div class='webex-radiogroup' id='radio_GPRILLXBRQ'><label><input type="radio" autocomplete="off" name="radio_GPRILLXBRQ" value=""></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_GPRILLXBRQ" value=""></input> <span>arrange()</span></label><label><input type="radio" autocomplete="off" name="radio_GPRILLXBRQ" value="answer"></input> <span>mutate()</span></label><label><input type="radio" autocomplete="off" name="radio_GPRILLXBRQ" value=""></input> <span>filter()</span></label></div>


5. Which boolean expression would I add to a `filter()` function to keep only Male babies in the original `babynames` data? <div class='webex-radiogroup' id='radio_AHSFLKGWKW'><label><input type="radio" autocomplete="off" name="radio_AHSFLKGWKW" value=""></input> <span>sex == F</span></label><label><input type="radio" autocomplete="off" name="radio_AHSFLKGWKW" value="answer"></input> <span>sex == M</span></label><label><input type="radio" autocomplete="off" name="radio_AHSFLKGWKW" value=""></input> <span>sex < F</span></label><label><input type="radio" autocomplete="off" name="radio_AHSFLKGWKW" value=""></input> <span>Sex == M</span></label></div>
