...
The answer to this last question was: <div class='webex-radiogroup' id='radio_WUQWOMZVJR'><label><input type="radio" autocomplete="off" name="radio_WUQWOMZVJR" value="answer"></input> <span>187.299472274669</span></label><label><input type="radio" autocomplete="off" name="radio_WUQWOMZVJR" value=""></input> <span>175.352037231422</span></label><label><input type="radio" autocomplete="off" name="radio_WUQWOMZVJR" value=""></input> <span>193.581696140348</span></label><label><input type="radio" autocomplete="off" name="radio_WUQWOMZVJR" value=""></input> <span>176.2</span></label></div>
