...
* What was the total number of hits made with the small paddle (50) and the blue colour background? <div class='webex-radiogroup' id='radio_OASSKMSCRE'><label><input type="radio" autocomplete="off" name="radio_OASSKMSCRE" value=""></input> <span>516</span></label><label><input type="radio" autocomplete="off" name="radio_OASSKMSCRE" value="answer"></input> <span>527</span></label><label><input type="radio" autocomplete="off" name="radio_OASSKMSCRE" value=""></input> <span>1057</span></label><label><input type="radio" autocomplete="off" name="radio_OASSKMSCRE" value=""></input> <span>1059</span></label></div>




* To three decimal places, what was the mean number of hits made with the small paddle (50) and the blue colour background? <div class='webex-radiogroup' id='radio_GCMSZNRUEK'><label><input type="radio" autocomplete="off" name="radio_GCMSZNRUEK" value="answer"></input> <span>0.459</span></label><label><input type="radio" autocomplete="off" name="radio_GCMSZNRUEK" value=""></input> <span>0.451</span></label><label><input type="radio" autocomplete="off" name="radio_GCMSZNRUEK" value=""></input> <span>0.922</span></label><label><input type="radio" autocomplete="off" name="radio_GCMSZNRUEK" value=""></input> <span>0.92</span></label></div>
...
2. Which of the Wickham Six would you use to sort columns from smallest to largest: <div class='webex-radiogroup' id='radio_GVULEHAYLT'><label><input type="radio" autocomplete="off" name="radio_GVULEHAYLT" value=""></input> <span>select</span></label><label><input type="radio" autocomplete="off" name="radio_GVULEHAYLT" value=""></input> <span>filter</span></label><label><input type="radio" autocomplete="off" name="radio_GVULEHAYLT" value=""></input> <span>mutate</span></label><label><input type="radio" autocomplete="off" name="radio_GVULEHAYLT" value="answer"></input> <span>arrange</span></label><label><input type="radio" autocomplete="off" name="radio_GVULEHAYLT" value=""></input> <span>group_by</span></label><label><input type="radio" autocomplete="off" name="radio_GVULEHAYLT" value=""></input> <span>summarise</span></label></div>

3. Which of the Wickham Six would you use to calculate the mean of a column: <div class='webex-radiogroup' id='radio_YQQCIYNFTZ'><label><input type="radio" autocomplete="off" name="radio_YQQCIYNFTZ" value=""></input> <span>select</span></label><label><input type="radio" autocomplete="off" name="radio_YQQCIYNFTZ" value=""></input> <span>filter</span></label><label><input type="radio" autocomplete="off" name="radio_YQQCIYNFTZ" value=""></input> <span>mutate</span></label><label><input type="radio" autocomplete="off" name="radio_YQQCIYNFTZ" value=""></input> <span>arrange</span></label><label><input type="radio" autocomplete="off" name="radio_YQQCIYNFTZ" value=""></input> <span>group_by</span></label><label><input type="radio" autocomplete="off" name="radio_YQQCIYNFTZ" value="answer"></input> <span>summarise</span></label></div>

4. Which of the Wickham Six would you use to remove certain observations - e.g. remove all males: <div class='webex-radiogroup' id='radio_FERYGVWHYQ'><label><input type="radio" autocomplete="off" name="radio_FERYGVWHYQ" value=""></input> <span>select</span></label><label><input type="radio" autocomplete="off" name="radio_FERYGVWHYQ" value="answer"></input> <span>filter</span></label><label><input type="radio" autocomplete="off" name="radio_FERYGVWHYQ" value=""></input> <span>mutate</span></label><label><input type="radio" autocomplete="off" name="radio_FERYGVWHYQ" value=""></input> <span>arrange</span></label><label><input type="radio" autocomplete="off" name="radio_FERYGVWHYQ" value=""></input> <span>group_by</span></label><label><input type="radio" autocomplete="off" name="radio_FERYGVWHYQ" value=""></input> <span>summarise</span></label></div>
 
5. What does this line of code say? `data %>% filter() %>% group_by() %>% summarise()`: <div class='webex-radiogroup' id='radio_IHGQIYEKJJ'><label><input type="radio" autocomplete="off" name="radio_IHGQIYEKJJ" value=""></input> <span>take the data and then group it and then filter it and then summarise it</span></label><label><input type="radio" autocomplete="off" name="radio_IHGQIYEKJJ" value="answer"></input> <span>take the data and then filter it and then group it and then summarise it</span></label><label><input type="radio" autocomplete="off" name="radio_IHGQIYEKJJ" value=""></input> <span>take the data and then summarise it and then filter it and then group it</span></label><label><input type="radio" autocomplete="off" name="radio_IHGQIYEKJJ" value=""></input> <span>take the data and then group it and then summarise it and then filter it</span></label></div>
