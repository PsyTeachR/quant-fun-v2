...
* Based on the information given, what will you set `type` as in the function? <div class='webex-radiogroup' id='radio_UTZNNRFHWJ'><label><input type="radio" autocomplete="off" name="radio_UTZNNRFHWJ" value=""></input> <span>one.sample</span></label><label><input type="radio" autocomplete="off" name="radio_UTZNNRFHWJ" value="answer"></input> <span>two.sample</span></label></div>
...
* According to Cohen (1988), the effect size for this t-test is <div class='webex-radiogroup' id='radio_ONWXEDWWBM'><label><input type="radio" autocomplete="off" name="radio_ONWXEDWWBM" value=""></input> <span>small to medium</span></label><label><input type="radio" autocomplete="off" name="radio_ONWXEDWWBM" value="answer"></input> <span>medium to large</span></label><label><input type="radio" autocomplete="off" name="radio_ONWXEDWWBM" value=""></input> <span>large</span></label></div>

* Say you run the study and find that the effect size determined is d = 0.50. Given what you know about power, select the statement that is true: <div class='webex-radiogroup' id='radio_TJJRMSOQSH'><label><input type="radio" autocomplete="off" name="radio_TJJRMSOQSH" value=""></input> <span>the study is sufficiently powered as the analysis indicates you can detect only effect sizes smaller than d = 0.65</span></label><label><input type="radio" autocomplete="off" name="radio_TJJRMSOQSH" value="answer"></input> <span>the study is underpowered as the analysis indicates you can detect only effect sizes larger than d = 0.65</span></label></div>
...
* Say you run the study and find that the effect size determined is d = 0.24. Given what you know about power, select the statement that is true: <div class='webex-radiogroup' id='radio_NUCIAXROVM'><label><input type="radio" autocomplete="off" name="radio_NUCIAXROVM" value=""></input> <span>the study is sufficiently powered as the analysis indicates you can detect only effect sizes smaller than d = 0.24</span></label><label><input type="radio" autocomplete="off" name="radio_NUCIAXROVM" value="answer"></input> <span>the study is underpowered as the analysis indicates you can detect only effect sizes larger than d = 0.34</span></label></div>
...
1. Assuming you were running a between-subjects t-test on secondary data ($\alpha = .05$, Power = .8, alternative = two-tailed) and that this secondary data has 100 participants in both groups. The smallest effect size, to three decimal places, you could determine with this data is: <div class='webex-radiogroup' id='radio_YEPDDTHBCD'><label><input type="radio" autocomplete="off" name="radio_YEPDDTHBCD" value=""></input> <span>d = 0.281</span></label><label><input type="radio" autocomplete="off" name="radio_YEPDDTHBCD" value=""></input> <span>d = 0.280</span></label><label><input type="radio" autocomplete="off" name="radio_YEPDDTHBCD" value=""></input> <span>d = 0.399</span></label><label><input type="radio" autocomplete="off" name="radio_YEPDDTHBCD" value="answer"></input> <span>d = 0.398</span></label></div>
...
2. Assuming you were running a between-subjects t-test on secondary data ($\alpha = .05$, Power = .8, alternative = two-tailed) and that this secondary data has 60 participants in Group 1 and 40 participants in Group 2. The smallest effect size, to three decimal places, you could determine with this data is: <div class='webex-radiogroup' id='radio_FTTPDRRPCM'><label><input type="radio" autocomplete="off" name="radio_FTTPDRRPCM" value="answer"></input> <span>d = 0.578</span></label><label><input type="radio" autocomplete="off" name="radio_FTTPDRRPCM" value=""></input> <span>d = 0.577</span></label><label><input type="radio" autocomplete="off" name="radio_FTTPDRRPCM" value=""></input> <span>r = .577</span></label><label><input type="radio" autocomplete="off" name="radio_FTTPDRRPCM" value=""></input> <span>r = .578</span></label></div>
...
3. Assuming you ran a correlation on secondary data ($\alpha = .05$, Power = .8, alternative = two-tailed) and that this secondary data has 50 observations. The smallest effect size, to three decimal places, you could determine with this data is: <div class='webex-radiogroup' id='radio_RAGEMUXGFG'><label><input type="radio" autocomplete="off" name="radio_RAGEMUXGFG" value=""></input> <span>r = .275</span></label><label><input type="radio" autocomplete="off" name="radio_RAGEMUXGFG" value="answer"></input> <span>r = .384</span></label><label><input type="radio" autocomplete="off" name="radio_RAGEMUXGFG" value=""></input> <span>r = .385</span></label><label><input type="radio" autocomplete="off" name="radio_RAGEMUXGFG" value=""></input> <span>r = .276</span></label></div>
