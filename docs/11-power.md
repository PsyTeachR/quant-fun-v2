...
1. Assuming you were running a between-subjects t-test on secondary data ($\alpha = .05$, Power = .8, alternative = two-tailed) and that this secondary data has 100 participants in both groups. The smallest effect size, to three decimal places, you could determine with this data is: <div class='webex-radiogroup' id='radio_BYFFDGVHLL'><label><input type="radio" autocomplete="off" name="radio_BYFFDGVHLL" value=""></input> <span>d = 0.281</span></label><label><input type="radio" autocomplete="off" name="radio_BYFFDGVHLL" value=""></input> <span>d = 0.280</span></label><label><input type="radio" autocomplete="off" name="radio_BYFFDGVHLL" value="answer"></input> <span>d = 0.398</span></label><label><input type="radio" autocomplete="off" name="radio_BYFFDGVHLL" value=""></input> <span>d = 0.399</span></label></div>
...
2. Assuming you were running a between-subjects t-test on secondary data ($\alpha = .05$, Power = .8, alternative = two-tailed) and that this secondary data has 60 participants in Group 1 and 40 participants in Group 2. The smallest effect size, to three decimal places, you could determine with this data is: <div class='webex-radiogroup' id='radio_DHBZYLDABM'><label><input type="radio" autocomplete="off" name="radio_DHBZYLDABM" value=""></input> <span>r = .578</span></label><label><input type="radio" autocomplete="off" name="radio_DHBZYLDABM" value="answer"></input> <span>d = 0.578</span></label><label><input type="radio" autocomplete="off" name="radio_DHBZYLDABM" value=""></input> <span>d = 0.577</span></label><label><input type="radio" autocomplete="off" name="radio_DHBZYLDABM" value=""></input> <span>r = .577</span></label></div>
...
3. Assuming you ran a correlation on secondary data ($\alpha = .05$, Power = .8, alternative = two-tailed) and that this secondary data has 50 observations. The smallest effect size, to three decimal places, you could determine with this data is: <div class='webex-radiogroup' id='radio_RNNMWPDIUQ'><label><input type="radio" autocomplete="off" name="radio_RNNMWPDIUQ" value=""></input> <span>r = .385</span></label><label><input type="radio" autocomplete="off" name="radio_RNNMWPDIUQ" value=""></input> <span>r = .275</span></label><label><input type="radio" autocomplete="off" name="radio_RNNMWPDIUQ" value="answer"></input> <span>r = .384</span></label><label><input type="radio" autocomplete="off" name="radio_RNNMWPDIUQ" value=""></input> <span>r = .276</span></label></div>
