...
1. What would this analysis show? <div class='webex-radiogroup' id='radio_HXCHACYUFX'><label><input type="radio" autocomplete="off" name="radio_HXCHACYUFX" value="answer"></input> <span>the relationship between IQ and the time spent reading at home</span></label><label><input type="radio" autocomplete="off" name="radio_HXCHACYUFX" value=""></input> <span>the relationship between IQ and Reading Ability</span></label><label><input type="radio" autocomplete="off" name="radio_HXCHACYUFX" value=""></input> <span>the relationship between IQ and the time spent watching TV at home</span></label><label><input type="radio" autocomplete="off" name="radio_HXCHACYUFX" value=""></input> <span>the effect of IQ on time spent reading at Home</span></label></div>

2. What type of correlation analysis is it? <div class='webex-radiogroup' id='radio_LKYBAILAAD'><label><input type="radio" autocomplete="off" name="radio_LKYBAILAAD" value=""></input> <span>two-tailed spearman analysis</span></label><label><input type="radio" autocomplete="off" name="radio_LKYBAILAAD" value="answer"></input> <span>two-tailed pearson analysis</span></label><label><input type="radio" autocomplete="off" name="radio_LKYBAILAAD" value=""></input> <span>one-tailed spearman analysis</span></label><label><input type="radio" autocomplete="off" name="radio_LKYBAILAAD" value=""></input> <span>one-tailed pearson analysis</span></label></div>


Now try running the code and then answering the following questions.

3. To three decimal places, what is the r-value of the correlation between IQ and the time spent reading at Home? <div class='webex-radiogroup' id='radio_QWUXTYBAZN'><label><input type="radio" autocomplete="off" name="radio_QWUXTYBAZN" value=""></input> <span>0.988</span></label><label><input type="radio" autocomplete="off" name="radio_QWUXTYBAZN" value=""></input> <span>0.553</span></label><label><input type="radio" autocomplete="off" name="radio_QWUXTYBAZN" value="answer"></input> <span>0.202</span></label><label><input type="radio" autocomplete="off" name="radio_QWUXTYBAZN" value=""></input> <span>0.334</span></label></div>


4. To three decimal places, what is the p-value of the correlation between IQ and the time spent reading at Home? <div class='webex-radiogroup' id='radio_XGNAFUCESD'><label><input type="radio" autocomplete="off" name="radio_XGNAFUCESD" value="answer"></input> <span>0.334</span></label><label><input type="radio" autocomplete="off" name="radio_XGNAFUCESD" value=""></input> <span>0.553</span></label><label><input type="radio" autocomplete="off" name="radio_XGNAFUCESD" value=""></input> <span>0.988</span></label><label><input type="radio" autocomplete="off" name="radio_XGNAFUCESD" value=""></input> <span>0.202</span></label></div>


5. What is the degrees of freedom of the correlation between IQ and the time spent reading at Home? <div class='webex-radiogroup' id='radio_FYTJLXGCOO'><label><input type="radio" autocomplete="off" name="radio_FYTJLXGCOO" value=""></input> <span>0.553</span></label><label><input type="radio" autocomplete="off" name="radio_FYTJLXGCOO" value=""></input> <span>0.988</span></label><label><input type="radio" autocomplete="off" name="radio_FYTJLXGCOO" value="answer"></input> <span>23</span></label><label><input type="radio" autocomplete="off" name="radio_FYTJLXGCOO" value=""></input> <span>25</span></label></div>
