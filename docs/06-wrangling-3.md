...
* The data in `responses` is in what format? <div class='webex-radiogroup' id='radio_TSTVGJIWPP'><label><input type="radio" autocomplete="off" name="radio_TSTVGJIWPP" value=""></input> <span>Tidy</span></label><label><input type="radio" autocomplete="off" name="radio_TSTVGJIWPP" value=""></input> <span>Long</span></label><label><input type="radio" autocomplete="off" name="radio_TSTVGJIWPP" value="answer"></input> <span>Wide</span></label></div>
...
* The cut-off for the AQ10 is usually said to be around 6 meaning that anyone with a score of more than 6 should be referred for diagnostic assessment. Based on this data, how many participants might be referred for further assessment? <div class='webex-radiogroup' id='radio_HLFWFTSMRH'><label><input type="radio" autocomplete="off" name="radio_HLFWFTSMRH" value=""></input> <span>2</span></label><label><input type="radio" autocomplete="off" name="radio_HLFWFTSMRH" value=""></input> <span>4</span></label><label><input type="radio" autocomplete="off" name="radio_HLFWFTSMRH" value="answer"></input> <span>6</span></label><label><input type="radio" autocomplete="off" name="radio_HLFWFTSMRH" value=""></input> <span>8</span></label></div>
