...
* The data in `responses` is in what format? <div class='webex-radiogroup' id='radio_JKMMRZWBOA'><label><input type="radio" autocomplete="off" name="radio_JKMMRZWBOA" value=""></input> <span>Tidy</span></label><label><input type="radio" autocomplete="off" name="radio_JKMMRZWBOA" value=""></input> <span>Long</span></label><label><input type="radio" autocomplete="off" name="radio_JKMMRZWBOA" value="answer"></input> <span>Wide</span></label></div>
...
* Complete the sentence, the higher the AQ score...<div class='webex-radiogroup' id='radio_ETEHKFAFPO'><label><input type="radio" autocomplete="off" name="radio_ETEHKFAFPO" value=""></input> <span>the less autistic-like traits displayed</span></label><label><input type="radio" autocomplete="off" name="radio_ETEHKFAFPO" value=""></input> <span>has no relation to autistic-like traits</span></label><label><input type="radio" autocomplete="off" name="radio_ETEHKFAFPO" value="answer"></input> <span>the more autistic-like traits displayed</span></label></div>
  

* Assuming that your code all worked, what was the AQ score (just the number) of Participant ID No. 87: <div class='webex-radiogroup' id='radio_RXAYEPSGZL'><label><input type="radio" autocomplete="off" name="radio_RXAYEPSGZL" value="answer"></input> <span>2</span></label><label><input type="radio" autocomplete="off" name="radio_RXAYEPSGZL" value=""></input> <span>3</span></label><label><input type="radio" autocomplete="off" name="radio_RXAYEPSGZL" value=""></input> <span>5</span></label><label><input type="radio" autocomplete="off" name="radio_RXAYEPSGZL" value=""></input> <span>6</span></label></div>
...
* The cut-off for the AQ10 is usually said to be around 6 meaning that anyone with a score of more than 6 should be referred for diagnostic assessment. Based on this data, how many participants might be referred for further assessment? <div class='webex-radiogroup' id='radio_YWAUFFXJXV'><label><input type="radio" autocomplete="off" name="radio_YWAUFFXJXV" value=""></input> <span>2</span></label><label><input type="radio" autocomplete="off" name="radio_YWAUFFXJXV" value=""></input> <span>4</span></label><label><input type="radio" autocomplete="off" name="radio_YWAUFFXJXV" value="answer"></input> <span>6</span></label><label><input type="radio" autocomplete="off" name="radio_YWAUFFXJXV" value=""></input> <span>8</span></label></div>
