...
* The data in `responses` is in what format? <div class='webex-radiogroup' id='radio_CLTWVMTEIH'><label><input type="radio" autocomplete="off" name="radio_CLTWVMTEIH" value=""></input> <span>Tidy</span></label><label><input type="radio" autocomplete="off" name="radio_CLTWVMTEIH" value=""></input> <span>Long</span></label><label><input type="radio" autocomplete="off" name="radio_CLTWVMTEIH" value="answer"></input> <span>Wide</span></label></div>
...
* Complete the sentence, the higher the AQ score...<div class='webex-radiogroup' id='radio_GMZMFVKKKQ'><label><input type="radio" autocomplete="off" name="radio_GMZMFVKKKQ" value=""></input> <span>the less autistic-like traits displayed</span></label><label><input type="radio" autocomplete="off" name="radio_GMZMFVKKKQ" value=""></input> <span>has no relation to autistic-like traits</span></label><label><input type="radio" autocomplete="off" name="radio_GMZMFVKKKQ" value="answer"></input> <span>the more autistic-like traits displayed</span></label></div>
  

* Assuming that your code all worked, what was the AQ score (just the number) of Participant ID No. 87: <div class='webex-radiogroup' id='radio_TKVGRJZYST'><label><input type="radio" autocomplete="off" name="radio_TKVGRJZYST" value="answer"></input> <span>2</span></label><label><input type="radio" autocomplete="off" name="radio_TKVGRJZYST" value=""></input> <span>3</span></label><label><input type="radio" autocomplete="off" name="radio_TKVGRJZYST" value=""></input> <span>5</span></label><label><input type="radio" autocomplete="off" name="radio_TKVGRJZYST" value=""></input> <span>6</span></label></div>
...
* The cut-off for the AQ10 is usually said to be around 6 meaning that anyone with a score of more than 6 should be referred for diagnostic assessment. Based on this data, how many participants might be referred for further assessment? <div class='webex-radiogroup' id='radio_FWDVJYDJKZ'><label><input type="radio" autocomplete="off" name="radio_FWDVJYDJKZ" value=""></input> <span>2</span></label><label><input type="radio" autocomplete="off" name="radio_FWDVJYDJKZ" value=""></input> <span>4</span></label><label><input type="radio" autocomplete="off" name="radio_FWDVJYDJKZ" value="answer"></input> <span>6</span></label><label><input type="radio" autocomplete="off" name="radio_FWDVJYDJKZ" value=""></input> <span>8</span></label></div>
