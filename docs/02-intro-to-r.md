...
1. One of the key first steps when we open RStudio is to: <div class='webex-radiogroup' id='radio_UCPJLSJOHR'><label><input type="radio" autocomplete="off" name="radio_UCPJLSJOHR" value="answer"></input> <span>set your working directory</span></label><label><input type="radio" autocomplete="off" name="radio_UCPJLSJOHR" value=""></input> <span>put on some top tunes as we will be here a while</span></label><label><input type="radio" autocomplete="off" name="radio_UCPJLSJOHR" value=""></input> <span>build some folders</span></label><label><input type="radio" autocomplete="off" name="radio_UCPJLSJOHR" value=""></input> <span>make a coffee</span></label></div>
...
4. Code chunks are started with: <div class='webex-radiogroup' id='radio_UAKJDIZGMP'><label><input type="radio" autocomplete="off" name="radio_UAKJDIZGMP" value=""></input> <span>three single quotes</span></label><label><input type="radio" autocomplete="off" name="radio_UAKJDIZGMP" value="answer"></input> <span>three backticks</span></label><label><input type="radio" autocomplete="off" name="radio_UAKJDIZGMP" value=""></input> <span>three double quotes</span></label><label><input type="radio" autocomplete="off" name="radio_UAKJDIZGMP" value=""></input> <span>three single clefs</span></label></div>
...
5. Inline coding is: <div class='webex-radiogroup' id='radio_VTOGFXTUSE'><label><input type="radio" autocomplete="off" name="radio_VTOGFXTUSE" value=""></input> <span>where you nicely organise your code in a line</span></label><label><input type="radio" autocomplete="off" name="radio_VTOGFXTUSE" value=""></input> <span>where you make sure all the code is nicely indented from the side</span></label><label><input type="radio" autocomplete="off" name="radio_VTOGFXTUSE" value=""></input> <span>an exuberant way of exclaiming you have written good code!</span></label><label><input type="radio" autocomplete="off" name="radio_VTOGFXTUSE" value="answer"></input> <span>an approach of intergrating code and text in a sentence outside of a code chunk</span></label></div>
