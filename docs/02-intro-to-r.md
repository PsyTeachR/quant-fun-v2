...
**My name is Emily and I am 35 years old. <br><br>It is -156 days until my birthday.**
...
1. One of the key first steps when we open RStudio is to: <div class='webex-radiogroup' id='radio_JPGYCMGVEW'><label><input type="radio" autocomplete="off" name="radio_JPGYCMGVEW" value="answer"></input> <span>set your working directory</span></label><label><input type="radio" autocomplete="off" name="radio_JPGYCMGVEW" value=""></input> <span>put on some top tunes as we will be here a while</span></label><label><input type="radio" autocomplete="off" name="radio_JPGYCMGVEW" value=""></input> <span>build some folders</span></label><label><input type="radio" autocomplete="off" name="radio_JPGYCMGVEW" value=""></input> <span>make a coffee</span></label></div>
