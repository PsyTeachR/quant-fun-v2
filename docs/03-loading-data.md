...
1. When loading in a .csv file, which function should you use? <div class='webex-radiogroup' id='radio_ZXYNZAOFBO'><label><input type="radio" autocomplete="off" name="radio_ZXYNZAOFBO" value="answer"></input> <span>read_csv()</span></label><label><input type="radio" autocomplete="off" name="radio_ZXYNZAOFBO" value=""></input> <span>read.csv()</span></label><label><input type="radio" autocomplete="off" name="radio_ZXYNZAOFBO" value=""></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_ZXYNZAOFBO" value=""></input> <span>library()</span></label></div>
...
3. What does the function `select()` do? <div class='webex-radiogroup' id='radio_CSGFZUOGKP'><label><input type="radio" autocomplete="off" name="radio_CSGFZUOGKP" value=""></input> <span>Keeps only the observations you specify</span></label><label><input type="radio" autocomplete="off" name="radio_CSGFZUOGKP" value="answer"></input> <span>Keeps only the columns you specify</span></label><label><input type="radio" autocomplete="off" name="radio_CSGFZUOGKP" value=""></input> <span>Keeps only the objects you specify</span></label></div>
