...
1. When loading in a .csv file, which function should you use? <div class='webex-radiogroup' id='radio_JSVUSISAJI'><label><input type="radio" autocomplete="off" name="radio_JSVUSISAJI" value="answer"></input> <span>read_csv()</span></label><label><input type="radio" autocomplete="off" name="radio_JSVUSISAJI" value=""></input> <span>read.csv()</span></label><label><input type="radio" autocomplete="off" name="radio_JSVUSISAJI" value=""></input> <span>select()</span></label><label><input type="radio" autocomplete="off" name="radio_JSVUSISAJI" value=""></input> <span>library()</span></label></div>
