...
1. Which of these is the appropriate order of functions to create a boxplot? <div class='webex-radiogroup' id='radio_LARBMXSQIM'><label><input type="radio" autocomplete="off" name="radio_LARBMXSQIM" value=""></input> <span>geom_boxplot() + ggplot()</span></label><label><input type="radio" autocomplete="off" name="radio_LARBMXSQIM" value=""></input> <span>geom_plot() + geom_boxplot()</span></label><label><input type="radio" autocomplete="off" name="radio_LARBMXSQIM" value="answer"></input> <span>ggplot() + geom_boxplot()</span></label><label><input type="radio" autocomplete="off" name="radio_LARBMXSQIM" value=""></input> <span>ggplot() %>% geom_boxplot()</span></label></div>
...
<div class='webex-radiogroup' id='radio_WRPFLTTPZS'><label><input type="radio" autocomplete="off" name="radio_WRPFLTTPZS" value="answer"></input> <span>No, because you have piped the geom_bar() instead of adding it</span></label><label><input type="radio" autocomplete="off" name="radio_WRPFLTTPZS" value=""></input> <span>Yes, as the code looks perfectly acceptable and no errors are visible</span></label></div>
...
<div class='webex-radiogroup' id='radio_SUTKMWTDVT'><label><input type="radio" autocomplete="off" name="radio_SUTKMWTDVT" value=""></input> <span>because you have not included a y axis</span></label><label><input type="radio" autocomplete="off" name="radio_SUTKMWTDVT" value=""></input> <span>because this would create a boxplot</span></label><label><input type="radio" autocomplete="off" name="radio_SUTKMWTDVT" value="answer"></input> <span>because there is no geom_barplot() and it should be geom_bar()</span></label><label><input type="radio" autocomplete="off" name="radio_SUTKMWTDVT" value=""></input> <span>because you have piped the barplot and not added it</span></label></div>


4. If I wanted a boxplot on top of a violin plot, what order of functions would I write? <div class='webex-radiogroup' id='radio_WECTMSRUCT'><label><input type="radio" autocomplete="off" name="radio_WECTMSRUCT" value=""></input> <span>ggplot() %>% geom_boxplot() %>% geom_violin()</span></label><label><input type="radio" autocomplete="off" name="radio_WECTMSRUCT" value=""></input> <span>ggplot() %>% geom_violin() %>% geom_boxplot()</span></label><label><input type="radio" autocomplete="off" name="radio_WECTMSRUCT" value=""></input> <span>ggplot() + geom_boxplot() + geom_violin()</span></label><label><input type="radio" autocomplete="off" name="radio_WECTMSRUCT" value="answer"></input> <span>ggplot() + geom_violin() + geom_boxplot()</span></label></div>
