...
As an example, let’s look at the help documentation for the function `rnorm()` - a function which randomly generates a set of numbers from what is known as the `r glossary("normal distribution")`. 
...
**Question 4.** Which of the following is most likely to be an argument? `r longmcq(sample(c("read_csv()", answer = "35", "<-")))`
