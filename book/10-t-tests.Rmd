...
* `r glossary("One-sample", display = "One-sample", def = "A study to compare the mean and spread of one group against a known value or population norm.", link = FALSE)` are used to study one group of people against a known norm or criterion - for example, comparing the mean IQ of a sample against a known population norm such as an IQ of 100.
